    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-5 px-5 pl-lg-0 pb-5 pb-lg-0">
                <img class="img-fluid w-100 rounded-circle shadow-sm" src="assets/img/1.jpeg" alt="">
            </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 pb-4 pb-lg-0">
                <img class="img-fluid rounded w-100 " src="assets/img/2.jpeg" alt="">
            </div>
            <div class="col-lg-7">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6 py-2">
                        <h6>Birthday: <span class="text-secondary">3rd December 2002</span></h6>
                    </div>
                    <div class="col-sm-6 py-2">
                        <h6>Degree: <span class="text-secondary">Studing</span></h6>
                    </div>
                    <div class="col-sm-6 py-2">
                        <h6>Experience: <span class="text-secondary">Yes</span></h6>
                    </div>
                    <div class="col-sm-6 py-2">
                        <h6>Phone: <span class="text-secondary">+91 9311828408</span></h6>
                    </div>
                    <div class="col-sm-6 py-2">
                        <h6>Email: <span class="text-secondary">Nipunbansal0987@gmail.com</span>
                        </h6>
                    </div>
                    <div class="col-sm-6 py-2">
                        <h6>Address: <span class="text-secondary">Sector-3, Rohini,
                                Delhi=110085</span></h6>
                    </div>
                    <div class="col-sm-6 py-2">
                        <h6>Freelance: <span class="text-secondary">Nipun B.@nipunbansal0987</span></h6>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="border-left border-primary pt-2 pl-4 ml-2">
                    <div class="position-relative mb-4">
                        ...
                        <h5 class="font-weight-bold mb-1">10th Standard</h5>
                        <p class="mb-2"><strong>NIOS</strong> | <small>
                                2018</small></p>
                        <p>I have completed my 10th education from National Institute of Open Schooling (NIOS) , Delhi in the year 2017-2018 carrying alongside the passion for coding and also Web Designing and Development , securing 75% in the final examination.</p>
                    </div>
                    <div class="position-relative mb-4">
                        <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                        <h5 class="font-weight-bold mb-1">11th-12th Standard</h5>
                        <p class="mb-2"><strong>NIOS</strong> | <small>2019 - 2021</small></p>
                        <p>I have completed my 12th education from National Institute of Open Schooling (NIOS) , Delhi in the year 2019-2020 opting Commerce(with Maths) as a stream and IP (Computer Education ) as an additional subject in the view of pursuing Web Designing and Development , securing 82% in the final examination.</p>
                    </div>
            ...
            <div class="col-lg-6"><br><br>
                <div class="border-left border-primary pt-2 pl-4 ml-2">
                    ...
                    <div class="position-relative mb-4">
                        ...
                        <p>Trained myself professionally in Full Stack Development and got Diploma in this field from one of the finest institution of computer education in Delhi , Delhi School of Skill Development (DSSD). I am aware of languages such as HTML, CSS, Bootstrap, JavaScript, PHP(MySQL) etc.</p>
                    </div>
                    <div class="position-relative mb-4">
                        <i class="far fa-dot-circle text-primary position-absolute" style="top: 2px; left: -32px;"></i>
                        <h5 class="font-weight-bold mb-1">B.Com</h5>
                        <p class="mb-2"><strong>DU (Delhi University)</strong> | <small>Studing</small></p>
                        <p>Being an Under-Graduate I am currently pursuing my Bachelors in Commerce(B.Com) from Delhi University (DU) alongside providing service In Zoom Insurance Brokers Pvt Ltd. , CyberCity as a Web Developer from past 1 year.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                ...
                <div class="skill mb-4">
                    <div class="d-flex justify-content-between">
                        <h6 class="font-weight-bold">PHP With MySQL</h6>
            ...
            <div class="col-md-6">
                ...
                <div class="skill mb-4">
                    ...
                    <div class="progress">
                        <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="69" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
                <div class="skill mb-4">
                    <div class="d-flex justify-content-between">
                        <h6 class="font-weight-bold">Codeigniter</h6>
                ...
                <div class="skill mb-4">
                    <div class="d-flex justify-content-between">
                        <h6 class="font-weight-bold">Software Testing</h6>
                        <h6 class="font-weight-bold">80%</h6>
                    </div>
                    <div class="progress">
    ...
    <div class="container">
        ...
        <div class="row pb-3">
            <div class="col-lg-4 col-md-6 text-center mb-5">
                ...
                <p>A full stack developer is a professional who has a good understanding of the entire web development process and can work on both the front-end and back-end parts of a web application. They are responsible for developing and maintaining the software applications that are used by end-users.
            ...
            <div class="col-lg-4 col-md-6 text-center mb-5">
                ...
                <p>Web designing is the process of creating websites, which includes designing the layout, visual elements, and content for web pages. It involves using various design tools and techniques to create a visually appealing and functional website that is easy to use and navigate. </p>
            ...
            <div class="col-lg-4 col-md-6 text-center mb-5">
                ...
                <p>Web development refers to the process of creating websites or web applications, which involves writing code and programming languages to build the functionality and features of a website. It includes all the technical aspects of creating a website, such as server-side scripting, database management. </p>
            ...
            <div class="col-lg-8">
                <div class="owl-carousel testimonial-carousel">
                    <div class="text-center">
                        ...
                        <h4 class="font-weight-light font-family-cursive mb-4" style="font-family:Georgia, Times, “Times New Roman”, serif;">One of the things I appreciated most about working with nipun was their attention to detail and their commitment to delivering a high-quality product. They were always available to answer any questions I had and made sure that I was completely satisfied with the final result.</h4>
                    ...
                    <div class="text-center">
                        <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                        <h4 class="font-weight-light mb-4" style="font-family:Georgia, Times, “Times New Roman”, serif;">I used to spend hours finding an appropriate web developer who can design a website according to my business. Finally I found nipun's website , he took time to listen to my ideas and concerns and provided valuable input and recommendations throughout the development process.</h4>
                    ...
                    <div class="text-center">
                        <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                        <h4 class="font-weight-light mb-4" style="font-family:Georgia, Times, “Times New Roman”, serif;">I recently had the pleasure of working with Nipun on a website project for my business and I can confidently say that their expertise and professionalism exceeded my expectations. From the initial consultation to the final launch of the website, Nipun demonstrated exceptional communication skills and a strong understanding of my business needs.</h4>
            ...
            <div class="col-lg-8">
                <div class="contact-form text-center">
                    ...
                    <form name="sentMessage" method="post" enctype="text/plain" id="contactForm" novalidate="novalidate">
                        ...
                        <div>
                            <input class="btn btn-outline-primary" type="submit" id="sendMessageButton" value="Send Message"></input>
                        </div>
                    </form>
                </div>
            </div>
